...
const cases = [
 ...
 ['book baby paediatrician next tue', {title:'Book baby paediatrician', due:'2026-09-22', area:'child'}],
 ...
 ['order nappies on noon', {list:'buy', shop:'Noon', area:'child', title:'Order nappies'}],
 ['swim with the baby sat morning', {due:'2026-09-19'}],
 ['sit in the sun with a book', {due:null}],
 ['buy summer shirts', {due:null, list:'buy'}],
 ['swim with the baby on sat morning', {due:'2026-09-19', slot:'morning'}],
